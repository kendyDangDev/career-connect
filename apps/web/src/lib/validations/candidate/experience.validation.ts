...
export const createCandidateExperienceSchema = z
  .object({
    ...
    achievements: z.string().max(2000, 'Achievements is too long').optional().nullable(),
  })
  .refine(
    (data) => {
...
export const updateCandidateExperienceSchema = z.object({
  ...
  achievements: z.string().max(2000, 'Achievements is too long').nullable().optional(),
});

// Bulk create candidate experience schema
export const bulkCreateCandidateExperienceSchema = z.object({
  experiences: z
    .array(createCandidateExperienceSchema)
...
export type BulkCreateCandidateExperienceInput = z.infer<
  typeof bulkCreateCandidateExperienceSchema
>;
