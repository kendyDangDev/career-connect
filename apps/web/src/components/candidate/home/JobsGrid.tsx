...
export default function JobsGrid() {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-white via-purple-50/30 to-white py-4">
      ...
      <div className="relative z-10 pt-10 pb-16">
        ...
        {loading ? (
          <div className="relative">
            <div className="absolute inset-0 -mx-4 rounded-3xl bg-white/60 shadow-xl shadow-purple-100/50 backdrop-blur-sm sm:-mx-6 lg:-mx-8" />
            <div className="relative grid grid-cols-1 gap-5 p-4 sm:grid-cols-2 sm:p-6 lg:grid-cols-3 lg:gap-6 lg:p-8">
              {Array.from({ length: 9 }).map((_, i) => (
                <div
                  key={i}
          ...
          <div className="flex flex-col items-center justify-center rounded-3xl bg-white/60 py-24 text-center shadow-xl shadow-purple-100/50 backdrop-blur-sm">
            ...
            <p className="mb-6 max-w-md text-gray-600">
              Hiện chưa có việc làm trong danh mục này. Hãy thử chọn danh mục khác hoặc quay lại sau
              nhé!
            </p>
            <button
