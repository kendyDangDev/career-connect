...
export const createCandidateEducationSchema = z
  .object({
    institutionName: z
      .string()
...
export const bulkCreateCandidateEducationSchema = z.object({
  education: z
    .array(createCandidateEducationSchema)
...
export const getCandidateEducationQuerySchema = z.object({
  sortBy: z.enum(['startDate', 'endDate', 'createdAt', 'gpa']).optional().default('startDate'),
