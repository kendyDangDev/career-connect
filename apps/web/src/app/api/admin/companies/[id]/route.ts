...
// GET: Get company details (Admin with company.view permission)
...
// PUT: Update company (Admin with company.edit permission)
...
// DELETE: Delete company (Admin with company.delete permission)
