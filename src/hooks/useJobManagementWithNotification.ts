  ...
  const onSuccess = useCallback(
    (operation: string, data?: any) => {
      ...
      switch (operation) {
        ...
        case 'update':
          notifications.success('✅ Cập nhật thành công', 'Thông tin công việc đã được cập nhật');
          break;
        ...
        case 'delete':
          notifications.warning('🗑️ Đã xóa công việc', 'Công việc đã được xóa khỏi hệ thống');
          break;
