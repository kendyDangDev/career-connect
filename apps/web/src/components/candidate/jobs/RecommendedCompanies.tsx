...
export default async function RecommendedCompanies() {
  ...
  return (
    <div className="rounded-2xl border border-purple-100 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900 mt-6">
          ...
          >
            ...
            <div className="flex-1 overflow-hidden">
              ...
              <div className="mt-1 flex items-center gap-3 text-[11px] font-medium text-slate-500 dark:text-slate-400">
                <span className="flex items-center gap-1 bg-purple-100/50 px-1.5 py-0.5 rounded text-purple-700 dark:bg-purple-900/30 dark:text-purple-300">
