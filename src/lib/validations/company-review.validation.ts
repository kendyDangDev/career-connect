...
export const createCompanyReviewSchema = z.object({
  ...
  salaryBenefitRating: ratingSchema
    .optional()
    .nullable(),
...
export const getCompanyReviewsQuerySchema = z.object({
  ...
  sortBy: z.enum(['createdAt', 'rating', 'workLifeBalanceRating', 'salaryBenefitRating', 'managementRating', 'cultureRating'])
    .optional()
    .default('createdAt'),
