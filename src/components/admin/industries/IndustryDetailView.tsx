    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Thông tin chi tiết và thống kê về ngành
          </DialogDescription>
        </DialogHeader>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <p className="text-sm text-muted-foreground">Mã ngành</p>
                    <p className="font-medium">{industry.code}</p>
                  </div>
                  <div>
                    <p className="text-sm text-muted-foreground">Tên ngành</p>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between p-3 rounded-lg bg-muted">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="text-sm text-muted-foreground">Danh mục hoạt động</p>
