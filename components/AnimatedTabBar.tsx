...
import { Bell, Book, BookCheckIcon, Briefcase, Clipboard, Home, User } from 'lucide-react-native';
...
const AnimatedTabBar: React.FC<BottomTabBarProps> = ({ 
  ...
  return (
    ...
    >
      <View className="flex-row items-center" style={{ height: TAB_BAR_HEIGHT }}>
