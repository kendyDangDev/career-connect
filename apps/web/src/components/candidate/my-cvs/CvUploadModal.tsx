...
export default function CvUploadModal({ open, onClose, onUploaded }: CvUploadModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!cvName.trim()) { setError('Vui lòng nhập tên CV.'); return; }
      ...
      <div className="relative bg-white dark:bg-slate-900 rounded-2xl shadow-2xl w-full max-w-md border border-slate-200 dark:border-slate-700">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-slate-100 dark:border-slate-800">
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">PDF hoặc DOCX, tối đa {MAX_MB}MB</p>
          </div>
          <button
            onClick={handleClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
            ...
            {file ? (
              <div className="flex items-center justify-center gap-3">
                ...
                <div className="text-left">
                  <p className="font-semibold text-sm text-slate-800 dark:text-white line-clamp-1">{file.name}</p>
              ...
              <>
                ...
                <p className="text-sm font-medium text-slate-700 dark:text-slate-300">
                  ...
                  <span className="text-purple-600 font-semibold">chọn file</span>
                </p>
          ...
          <div className="flex gap-3 pt-1">
            ...
            <button
              ...
              className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-xl bg-purple-600 text-white text-sm font-semibold hover:bg-purple-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
